...
Expected Output in log_report_5.txt:
------------
    IP                  DATE                URL
...
print("Get data from log_report.json file")
print("-"*20)
# -------------
...
print("Access each value in json_file_content list")
print("-"*20)
# -------------
...
print("Write to log_report_5.txt file")
print("-"*20)
# -------------
...
print("""
Created log_report_5.txt, Please check
""")
